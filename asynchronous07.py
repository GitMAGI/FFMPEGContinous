...
def job08():
    ...
    while True:
        ...
        #print("In reading ...")
        output_data_slice = output_process.stdout.readline()

        if output_data_slice == '' and output_process.poll() is not None:
            break

        #print("Data Read. Size of %d B", len(output_data_slice))
